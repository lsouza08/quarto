class Quarto:
    def __init__(self, nome:str, dimensoes:str):
        self.nome = nome
...
class Casa:
    def __init__(self, formato=str, quartos=None):
        self.formato=formato
        if quartos is None: # regra da composição
            raise Exception("A casa precisa ter pelo menos um quarto")
    ...
    def __str__(self):
        ...
        return s
    #def __adicionar__(self, formato=str, local=str, tipo=str):
        self.formato=formato
        self.local=local
        self.tipo=tipo 
